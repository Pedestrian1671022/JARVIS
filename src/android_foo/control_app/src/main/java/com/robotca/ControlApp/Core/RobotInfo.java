...
public class RobotInfo implements Comparable<RobotInfo>, Savable {
    ...
    public RobotInfo() {
        ...
        cameraTopic = "/vision/rgb/image_raw/compressed";
        laserTopic = "/scan";
...
//                Log.d(TAG, "name = " + info.getName().substring(5));
    ...
    public void load(@NonNull Bundle bundle) {
        ...
        joystickTopic = bundle.getString(JOYSTICK_TOPIC_KEY, "/cmd_vel_dumped");
        ...
        cameraTopic = bundle.getString(CAMERA_TOPIC_KEY, "/vision/rgb/image_raw/compressed");
    ...
    public void load(@NonNull SharedPreferences prefs) {
        joystickTopic = prefs.getString(RobotStorage.getPreferenceKey(JOYSTICK_TOPIC_KEY), "/cmd_vel_dumped");
        ...
        cameraTopic = prefs.getString(RobotStorage.getPreferenceKey(CAMERA_TOPIC_KEY), "/vision/rgb/image_raw/compressed");
